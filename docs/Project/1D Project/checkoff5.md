---
layout: default
title: Checkoff 5 (Peer Review)
permalink: /project/checkoff-5
...
Everyone need to complete the Peer Review Rating and Writeup **([rubric](https://drive.google.com/file/d/18zBk5MDIMPpWkZrQDMTH80G4WSlwXeXD/view?usp=sharing)):

- Done via **TEAMMATES** (check your **SUTD** email in Week 12)
- You are to rate **EACH** of your teammates **and yourself** and give each person a rating 0 to 8. You can find the description in the [rubric](#rubric) below.
