...
Figure out how you should connect `slow_clock` signal (it represents a wire). It should be connected to an output of a dvice whereby that signal is the slow clock. 
