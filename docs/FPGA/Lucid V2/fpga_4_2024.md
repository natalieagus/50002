...
To understand the constraint file, **create** a new project with Alchitry Au Board and Io Demo V1 as the template. 

<img src="{{ site.baseurl }}//docs/FPGA/Lucid%20V2/images/fpga_4_2024/2025-01-17-16-12-46.png"  class="center_seventy no-invert"/> 
<img src="{{ site.baseurl }}//docs/FPGA/Lucid%20V2/images/fpga_4_2024/2025-01-17-16-37-08.png"  class="center_seventy no-invert"/>
...
The v1 constraint file that comes with this template does not have a pulldown. Delete it, and add the V1 constraint with pulldown:
<img src="{{ site.baseurl }}//docs/FPGA/Lucid%20V2/images/fpga_4_2024/2025-01-17-19-34-44.png"  class="center_seventy no-invert"/>
