...
{:.note}
> If you want to connect multiple 8x8 matrices, then you need to daisy-chain several MAX7219/7221 chips. You can change the `CHAIN` parameter in the demo code to test that.
