...
A combinational digital device is a type of digital decice where its output is a <span class="orange-bold">pure function</span> of the present input only *(there's no memory of past inputs)*. It is **stateless** and has the following criteria:
